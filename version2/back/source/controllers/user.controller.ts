...
export class UserConroller {
        ...
        if (validate !== "true") {
            ...
            ValidateController.alreadyExist(sqlUsername).then((result) => {
                ...
                if (result) {
                    ...
                    const sql = `insert into users (username,pwd)
        ...
        if (!data.id) {
            ...
            ValidateController.alreadyExist(sqlUsername).then((result) => {
                ...
                if (result) {
                    ...
                    const sql = `update users set  username='${data.username}', pwd='${data.password}' where id='${data.id}'`;
    ...
    public static listPage(req: Request, res: Response) {
        ...
        const sqlPage = `select * from users limit ${limit} offset ${offset} `;
