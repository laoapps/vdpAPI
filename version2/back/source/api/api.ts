...
app.post('/listPageprovince_by',  provinceConroller.listPage_by);
...
app.get('/listPageprovince_by',  provinceConroller.listPage_by);
...
app.post('/listPagedis_by',  districtConroller.listPage_by);
...
app.post('/listAllSbydid',  districtConroller.listAllSbydid);


app.post('/getDistrict_by_provinceID',  districtConroller.getDistrict_by_provinceID);

app.get('/listPagedis_by',  districtConroller.listPage_by);
...
app.get('/listAllSbydid',  districtConroller.listAllSbydid);
